    ...
    menuItems: [
      {
        icon: (
          <svg
            ...
            width="2em"
          >
            <path d="M12 3L2 12h3v8h14v-8h3M9 18H7v-6h2m4 6h-2v-8h2m4 8h-2v-4h2" />
          </svg>
        ),
        label: "Inicio",
        route: "/dashboard/ebooks",
      },
      {
        icon: (
          <svg
      ...
      //     { label: "Form Layout", route: "/forms/coloringbook" },
      //   ],
      // },
      // {
      //   icon: (
      ...
      >
        ...
        <div className="flex items-center justify-between  gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            ...
            <p className="text-lime-50 uppercase">Stocky</p>
          </Link>
